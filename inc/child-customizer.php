...
class Child_Theme_Customizer
{
 ...
 public function childtheme_add_customizer_sections($wp_customize)
 {
  ...
  $wp_customize->add_section(
   ...
   array(
    ...
    'description' => esc_html__('Here you can configure some things for the menu', 'skyrocket'),
    'panel'       => 'child_theme_settings_panels',
   )
  );
 }
 ...
 public function childtheme_register_custom_controls($wp_customize)
 {
  ...
  $wp_customize->add_control(
   '_other_text',
   array(
    'label'       => __('Write the other text here', 'skyrocket'),
    'description' => esc_html__('This text appers in the footer', 'skyrocket'),
    'section'     => 'general_section',
    'type'        => 'text',
    'input_attrs' => array(
     'placeholder' => __('Enter text...', 'skyrocket'),
    ),
   )
  );
  ...
  $wp_customize->add_control(
   '_text_after_number',
   array(
    'label'       => __('After Text of Phone Number', 'skyrocket'),
    'description' => esc_html__('Type the Text after phone number', 'skyrocket'),
    'section'     => 'menu_section',
    'type'        => 'text',
    'input_attrs' => array(
     'placeholder' => __('Enter text...', 'skyrocket'),
  ...
  $wp_customize->add_control(
   '_address',
   array(
    'label'       => __('Write the address here', 'skyrocket'),
    'description' => esc_html__('Write the address here', 'skyrocket'),
    'section'     => 'menu_section',
    'type'        => 'text',
    'input_attrs' => array(
     'placeholder' => __('Enter text...', 'skyrocket'),
  ...
  $wp_customize->add_control(
   '_email',
   array(
    'label'       => __('Email', 'skyrocket'),
    'description' => esc_html__('Write the email contact here', 'skyrocket'),
    'section'     => 'menu_section',
    'type'        => 'email',
   )
  );
 ...
 public function skyrocket_register_sample_custom_controls($wp_customize)
 {
  ...
  $wp_customize->add_control(
   new Skyrocket_Slider_Custom_Control(
    $wp_customize, 'sample_slider_control',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Slider_Custom_Control(
    $wp_customize, 'sample_slider_control_small_step',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Sortable_Repeater_Custom_Control(
    $wp_customize, 'sample_sortable_repeater_control',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Image_Radio_Button_Custom_Control(
    $wp_customize, 'sample_image_radio_button',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Text_Radio_Button_Custom_Control(
    $wp_customize, 'sample_text_radio_button',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Image_checkbox_Custom_Control(
    $wp_customize, 'sample_image_checkbox',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Single_Accordion_Custom_Control(
    $wp_customize, 'sample_single_accordion',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Customize_Alpha_Color_Control(
    $wp_customize, 'sample_alpha_color',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Alpha_Color_Control(
    $wp_customize, 'sample_wpcolorpicker_alpha_color',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Alpha_Color_Control(
    $wp_customize, 'sample_wpcolorpicker_alpha_color2',
    array(
     'label'       => __('WP ColorPicker Alpha Color Picker', 'skyrocket'),
     'description' => esc_html__('Sample color control with Alpha channel', 'skyrocket'),
     'section'     => 'sample_custom_controls_section',
  ...
  $wp_customize->add_control(
   new Skyrocket_Pill_Checkbox_Custom_Control(
    $wp_customize, 'sample_pill_checkbox',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Pill_Checkbox_Custom_Control(
    $wp_customize, 'sample_pill_checkbox2',
    array(
     'label'       => __('Pill Checkbox Control', 'skyrocket'),
  ...
  $wp_customize->add_control(
   new Skyrocket_Pill_Checkbox_Custom_Control(
    $wp_customize, 'sample_pill_checkbox3',
    array(
     'label'       => __('Pill Checkbox Control', 'skyrocket'),
  ...
  $wp_customize->add_control(
   new Skyrocket_Simple_Notice_Custom_control(
    $wp_customize, 'sample_simple_notice',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Dropdown_Select2_Custom_Control(
    $wp_customize, 'sample_dropdown_select2_control_single',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Dropdown_Select2_Custom_Control(
    $wp_customize, 'sample_dropdown_select2_control_multi',
    array(
     'label'       => __('Dropdown Select2 Control', 'skyrocket'),
  ...
  $wp_customize->add_control(
   new Skyrocket_Dropdown_Select2_Custom_Control(
    $wp_customize, 'sample_dropdown_select2_control_multi2',
    array(
     'label'       => __('Dropdown Select2 Control', 'skyrocket'),
  ...
  $wp_customize->add_control(
   new Skyrocket_Dropdown_Posts_Custom_Control(
    $wp_customize, 'sample_dropdown_posts_control',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_TinyMCE_Custom_control(
    $wp_customize, 'sample_tinymce_editor',
    array(
  ...
  $wp_customize->add_control(
   new Skyrocket_Google_Font_Select_Custom_Control(
    $wp_customize, 'sample_google_font_select',
    array(
 ...
 public function skyrocket_register_sample_default_controls($wp_customize)
 {
  ...
  $wp_customize->add_control(
   new WP_Customize_Media_Control(
    $wp_customize, 'sample_default_media',
    array(
  ...
  $wp_customize->add_control(
   new WP_Customize_Image_Control(
    $wp_customize, 'sample_default_image',
    array(
  ...
  $wp_customize->add_control(
   new WP_Customize_Cropped_Image_Control(
    $wp_customize, 'sample_default_cropped_image',
    array(
  ...
  $wp_customize->add_control(
   new WP_Customize_Date_Time_Control(
    $wp_customize, 'sample_date_time_no_past_date',
    array(
     'label'              => __('Default Date Control', 'skyrocket'),
