    ...
    class Understrap_WP_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            if (isset($args->has_children) && $args->has_children && 0 === $depth && 1 !== $args->depth) {
                ...
                $atts['class'] = 'dropdown-toggle nav-link fw-bold text-white fs-16';
                ...
                } else if(in_array($args->theme_location, array('footer_menu'))) {
                    $atts['class'] = 'nav-link text-white fs-16';
                } else {
                    $atts['class'] = 'nav-link fw-bold text-white fs-16';
                }
            }
